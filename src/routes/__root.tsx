  ...
  head: () => ({
    meta: [
      ...
      { title: "Jill Añonuevo — Workflow & Automation Specialist" },
      {
        name: "description",
        content:
          "Jill Añonuevo helps businesses streamline operations through workflow automation, systems implementation, and CRM optimization.",
      },
      { name: "author", content: "Jill Añonuevo" },
      { property: "og:title", content: "Jill Añonuevo — Workflow & Automation Specialist" },
      {
        property: "og:description",
        content:
          "Workflow automation, systems implementation, and process improvement for agencies, startups, and growing businesses.",
      },
